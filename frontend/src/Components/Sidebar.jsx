    ...
    <div className="main_div">
      <div className="logo_div">
        <div className="logo_img">
          <img src="https://i.ibb.co/z5gMHWw/Logo.jpg" />
        </div>
      </div>

      <div className="items_div">
        <div className="search">
          <img src="https://i.ibb.co/QNnfhm6/Bar.jpg" />
        </div>
        <div className="dash">
          {/* <img
            src="https://i.ibb.co/WBSw7Qc/Sidebar-item-01.jpg"
            className="dash_img"
          /> */}
          <div>
            <svg
        ...
        <div className="customer">
          {/* <img
            src="https://i.ibb.co/MZ8DDfg/Sidebar-nest.jpg"
            alt="Sidebar-nest"
            border="0"
          /> */}
          <div className="cust_div">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
        ...
        <div className="report">
          {/* <img src="https://i.ibb.co/58p72WD/Sidebar-item-02.png" /> */}
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <div>
            <h2 className="report_txt">All reports</h2>
          </div>
        </div>
      ...
      <div className="user_div">
       <div className="info">
         <div>
          <img src="https://i.ibb.co/yRjwpy8/Avatar.png" />
         </div>

         <div className="frame_1">
           <div>
            <img src="https://i.ibb.co/52mdkTx/Gustavo-Xavier.png" />
           </div>
           <div>
            <img src="https://i.ibb.co/M6jGxWd/Tag.png"/>
           </div>
         </div>
